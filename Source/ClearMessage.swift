...
public class ClearMessage: Message {
    ...
    /// - Throws: SwiftyRSAError
    public func encrypted(with key: SwiftyRSAPublicKey, padding: Padding) throws -> EncryptedMessage {
    ...
    /// - Throws: SwiftyRSAError
    public func signed(with key: SwiftyRSAPrivateKey, digestType: Signature.DigestType) throws -> Signature {
    ...
    /// - Throws: SwiftyRSAError
    public func verify(with key: SwiftyRSAPublicKey, signature: Signature, digestType: Signature.DigestType) throws -> Bool {
